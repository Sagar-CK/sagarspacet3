...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center bg-gradient-to-b from-[#7e64f5] to-[#902fff]">
            ...
            <div className="flex max-w-xs flex-col gap-4 rounded-2xl">
              ...
              <div className="flex flex-col items-center justify-center gap-4">
                ...
                <div className="flex flex-row gap-4 justify-center">
                  ...
                  <button className="bg-[#283044] text-white rounded-md p-2">
                    <img src="/github.svg" alt="logo" className="w-8 text-[#283044]" />
                  </button>
                  <button className="bg-[#283044] text-white rounded-md p-2">
                    <img src="/linkedin.svg" alt="logo" className="w-8 text-[#283044]" />
                  </button>
                  <button className="bg-[#283044] fill-current text-[#283044] rounded-md p-2 ">
                    <img src="/twitter.svg" alt="logo" className="w-8" />
                  </button>
                </div>
              </div>
            </div>
            <div className="flex max-w-xs flex-col gap-5 rounded-xl bg-white/10 p-4 text-white hover:bg-white/20">
